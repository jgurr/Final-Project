Choice::Application.routes.draw do
 ...
 # Routes for the Selection resource:
  # CREATE
  get '/selections/new', controller: 'selections', action: 'new', as: 'new_selections'
  post '/selections', controller: 'selections', action: 'create'

  # READ
  get '/selections', controller: 'selections', action: 'index', as: 'selections'
  get '/selections/:id', controller: 'selections', action: 'show', as: 'selections'

  # UPDATE
  get '/selections/:id/edit', controller: 'selections', action: 'edit', as: 'edit_selections'
  put '/selections/:id', controller: 'selections', action: 'update'
