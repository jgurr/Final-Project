...
class SelectionsControllerTest < ActionController::TestCase
  ...
  test "should create selection" do
    assert_difference('Selection.count') do
      post :create, selection: { brands: @selection.brands, categories: @selection.categories, users: @selection.users }
    end
  ...
  test "should update selection" do
    put :update, id: @selection, selection: { brands: @selection.brands, categories: @selection.categories, users: @selection.users }
    assert_redirected_to selection_path(assigns(:selection))
  end
